...
class GazeComDataSetLoader(BaseDataSetLoader):
    ...
    __EVENT_MAPPING = {
        0: cnfg.EVENT_LABELS.UNDEFINED,
        1: cnfg.EVENT_LABELS.FIXATION,
        2: cnfg.EVENT_LABELS.SACCADE,
        3: cnfg.EVENT_LABELS.SMOOTH_PURSUIT,
        4: cnfg.EVENT_LABELS.UNDEFINED  # noise
    }
