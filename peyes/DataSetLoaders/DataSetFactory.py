...
from peyes.DataSetLoaders.BaseDataSetLoader import BaseDataSetLoader
from peyes.GazeDetectors.BaseDetector import BaseDetector
from peyes.GazeEvents.EventFactory import EventFactory
...
class DataSetFactory(ABC):
    ...
    def load(name: str) -> pd.DataFrame:
        """ Loads the dataset. """
        from peyes.DataSetLoaders.GazeComDataSetLoader import GazeComDataSetLoader
        from peyes.DataSetLoaders.HFCDataSetLoader import HFCDataSetLoader
        from peyes.DataSetLoaders.IRFDataSetLoader import IRFDataSetLoader
