...
from peyes.GazeEvents.helpers import count_labels_or_events
import peyes.Utils.metrics as metrics
import peyes.Analysis.helpers as hlp
...
class SampleMetricsCalculator(BaseCalculator):
    ...
    def __calculate_on_column_pairs(samples: pd.DataFrame, metric_name: str) -> pd.DataFrame:
        ...
        # The following are un-normalized metrics and provide very little additional information
