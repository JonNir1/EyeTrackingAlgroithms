...
class TestEngbertDetector(unittest.TestCase):
    ...
    def test_calculate_axial_velocity(self):
        ...
        self.assertTrue(np.array_equal(detector._calculate_axial_velocity(arr, self._SR), expected, equal_nan=True))
        ...
        self.assertTrue(np.allclose(detector._calculate_axial_velocity(arr, self._SR), expected, equal_nan=True))
