...
class EventMatcher(ABC):
    ...
    @staticmethod
    def generic_matcher(ground_truth: Sequence[BaseEvent],
        ...
        for gt in ground_truth:
            ...
            possible_matches = EventMatcher._find_matches(gt=gt,
            ...
            p = EventMatcher._choose_match(gt, possible_matches, reduction)
            if len(p):
                matches[gt] = p
            if reduction != "all":
    ...
    def first_overlap(ground_truth: Sequence[BaseEvent],
        ...
        """
        return EventMatcher.generic_matcher(ground_truth, predictions, allow_cross_matching, min_overlap=min_overlap,
                                            reduction="first")
    ...
    def iou(ground_truth: Sequence[BaseEvent],
        ...
        """
        return EventMatcher.generic_matcher(ground_truth, predictions, allow_cross_matching, min_iou=min_iou,
                                            reduction="iou")
    ...
    def onset_latency(ground_truth: Sequence[BaseEvent],
        ...
        """
        return EventMatcher.generic_matcher(ground_truth, predictions, allow_cross_matching,
